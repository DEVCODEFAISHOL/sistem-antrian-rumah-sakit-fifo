                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('staff.patients.update', $patient->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                           ...
                           <input type="text" name="no_telepon" id="no_telepon" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('no_telepon', $patient->no_telepon) }}">
                            @error('no_telepon')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                           @enderror
                       </div>
