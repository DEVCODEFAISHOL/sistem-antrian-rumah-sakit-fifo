        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h3 class="mb-4 text-xl font-semibold text-gray-800 dark:text-gray-200">Laporan Kunjungan Pasien</h3>
                      @if(session('success'))
                             ...
                             <thead class="bg-gray-50">
                                  <tr>
                                     <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tanggal Kunjungan</th>
                                      <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Total Kunjungan</th>
                                 </tr>
                           </thead>
                                ...
                                @forelse ($visitsByDate as $visit)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $visit->visit_date }}</td>
                                         <td class="px-6 py-4 whitespace-nowrap">{{ $visit->total_visits }}</td>
                                    </tr>
                                @empty
                                    <tr>
                                         <td class="px-6 py-4 whitespace-nowrap" colspan="2">Tidak ada data kunjungan.</td>
                                    </tr>
                                @endforelse
                           </tbody>
                        </table>
