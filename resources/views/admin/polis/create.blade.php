                        ...
                        @csrf
                         <div class="mb-4">
                          ...
                          <div class="mb-4">
                            ...
                            <input type="text" name="kode_poli" id="kode_poli" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('kode_poli') }}" required>
                             @error('kode_poli')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
                         ...
                         <div class="mb-4">
                            <label for="kapasitas_harian" class="block text-gray-700 text-sm font-bold mb-2">Kapasitas Harian</label>
                             <input type="number" name="kapasitas_harian" id="kapasitas_harian" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('kapasitas_harian') }}" required>
