                    ...
                    <form action="{{ route('admin.queues.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="is_emergency" class="block text-gray-700 text-sm font-bold mb-2">Darurat</label>
                              ...
                              <input type="checkbox" name="is_emergency" id="is_emergency" class="form-checkbox h-5 w-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500" value="1" {{ old('is_emergency') ? 'checked' : '' }}>
                              @error('is_emergency')
                                 <p class="text-red-500 text-xs italic">{{ $message }}</p>
                             @enderror
                          </div>
                       ...
                       <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('admin.queues.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                Batal
                            </a>
                        </div>
                    </form>
