<x-perfect-scrollbar as="nav" aria-label="main" class="flex flex-col flex-1 gap-4 px-3">
    ...
    @if (Auth::user()->hasRole('admin'))
        ...
        <x-sidebar.dropdown title="Monitoring & Reporting" :active="Str::startsWith(request()->route()->uri(), 'admin/reports')">
            ...
            <x-sidebar.sublink title="Laporan Waktu Tunggu" href="{{ route('admin.reports.waiting-time') }}"
                :active="request()->routeIs('admin.reports.waiting-time')" />
        </x-sidebar.dropdown>
    @endif
    ...
    @if (Auth::user()->hasRole('staff'))
        ...
        <x-sidebar.dropdown title="Kelola Pasien" :active="Str::startsWith(request()->route()->uri(), 'staff/patients')">
            ...
            <x-sidebar.sublink title="Pencarian Pasien" href="{{ route('staff.patients.search') }}"
                :active="request()->routeIs('staff.patients.search')" />
